...
import { useGetDesktopQuery } from "@/pages/home/product.api";
...
const ManageListDesktop = () => {
    const [searchParams] = useSearchParams();

    const { data, isFetching } = useGetDesktopQuery(searchParams.toString());
...
export default ManageListDesktop;
